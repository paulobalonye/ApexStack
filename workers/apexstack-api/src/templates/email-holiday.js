/* ============================================
   ...
   Generic template — dynamic holiday name
   and message from holidays.js
   ============================================ */

export function buildHolidayEmail({ firstName, holidayName, holidayMessage, unsubUrl }) {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Happy ${holidayName}!</title>
</head>
    ...
    <tr>
      <td align="center" style="padding: 40px 20px;">
        <table width="600" cellpadding="0" cellspacing="0" role="presentation" style="max-width: 600px; width: 100%;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="background: #111111; border-radius: 12px; border: 1px solid #222222;">
                <tr>
                  <td style="padding: 24px; text-align: center;">
                    <div style="color: #b8e600; font-size: 20px; font-weight: 700; padding-bottom: 12px;">${holidayName}</div>
                    <p style="color: #d1d5db; font-size: 14px; line-height: 1.7; margin: 0;">
                      From everyone at ApexStack Cloud, we wish you a wonderful holiday. Take a moment to relax, recharge, and enjoy the day with those who matter most.
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="color: #9ca3af; font-size: 15px; line-height: 1.7; padding-bottom: 24px;">
              We're grateful to be part of your cloud journey and look forward to continuing to build great things together.
            </td>
          </tr>

          <tr>
            <td style="color: #ffffff; font-size: 15px; font-weight: 600; line-height: 1.7; padding-bottom: 40px;">
              Warm regards,<br>The ApexStack Cloud Team
            </td>
          </tr>
